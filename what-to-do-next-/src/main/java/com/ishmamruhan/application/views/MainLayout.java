package com.ishmamruhan.application.views;
...
import com.ishmamruhan.application.views.task.TaskView;
...
public class MainLayout extends AppLayout {
    ...
    private Component createHeaderContent() {
        ...
        H1 appName = new H1("What To Do Next?");
    ...
    private MenuItemInfo[] createMenuItems() {
        ...
        MenuItemInfo itemInfo = null;

        if(position.equals("USER")){
            itemInfo = new MenuItemInfo("User", "la la-user", UserView.class);
        }
        else if(position.equals("SUPERVISOR")){
            itemInfo = new MenuItemInfo("Supervisor", "la la-broadcast-tower", SupervisorView.class);
        }
        else if(position.equals("ADMIN")){
            itemInfo = new MenuItemInfo("Admin", "la la-key", AdminView.class);
        }

        return new MenuItemInfo[]{
                itemInfo,
                new MenuItemInfo("Task", "la la-key", TaskView.class)
        };
    }
